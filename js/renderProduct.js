...
export async function renderProductsHandler(productsContainer, products, swiper = false) {
    ...
    products.forEach( p => {
        ...
        div.className = 'product_container swiper-slide';
                ...
                <button id="${p.id}" class="add-to-cart_btn">
                    <svg id="basket_icon" width="25px" height="25px" viewBox="0 0 24 24" fill="none"
                        ...
                        <path
                            ...
                            class="stroke-[var(--static-white-color)]" stroke-width="2" stroke-linecap="round" />
                        <path
                            ...
                            class="stroke-[var(--static-white-color)]" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                            ...
                            class="stroke-[var(--static-white-color)]" stroke-width="2" stroke-linecap="round" />
                        <circle cx="17" cy="20" r="1" class="fill-[var(--static-white-color)]" />
                        <circle cx="9" cy="20" r="1" class="fill-[var(--static-white-color)]" />
                    </svg>
                    add to Cart
                </button>
    ...
    await productsContainer.appendChild(docFrag);
